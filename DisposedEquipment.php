...
<head>
    ...
    <title>EIS | Disposed Equipments</title>
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="Homepage.php" class="logo">
                ...
                <span class="logo-lg"><b>Disposed</b></span>
            </a>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Disposed Equipments</h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="./Homepage.php"><i class="fa fa-dashboard"></i> Home</a>
                    </li>
                    <li class="active">Disposed</li>
                </ol>
            </section><table class="table">
  <thead>
    <tr>
      <th scope="col">Disposed Equipment</th>
      <th scope="col">Faculty Request</th>
      <th scope="col">Fix/Disposed</th>
      <th scope="col">Comments</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th scope="row">Computer set Core-i3</th>
      <td>Mark</td>
      <td>Disposed</td>
      <td>I need new advance technology and i don't get lag when i online class</td>
    </tr>
    <tr>
      <th scope="row">Desk with Chair</th>
      <td>Jacob</td>
      <td>Fix</td>
      <td>Having a wreck on my desk and chair.</td>
    </tr>
    <tr>
    <th scope="row">Core-i3 CPU</th>
      <td>Drake</td>
      <td>disposed</td>
      <td>Neeed advance specs for my class</td>
    </tr>
    <tr>
    <th scope="row">Computer set Core-i5</th>
      <td>Mariquit</td>
      <td>Fix</td>
      <td>Little bit error and blue screen will happen to computer set</td>
    </tr>
    <tr>
    <th scope="row">Old Graphics card</th>
      <td>Zed</td>
      <td>Disposed</td>
      <td>Need new graphics card, maybe u had one available?</td>
    </tr>
    <tr>
    <th scope="row">Printer 390MAX pro</th>
      <td>Bien</td>
      <td>disposed</td>
      <td>The printer was error need to be fix, before of the paper files.</td>
    </tr>
    <tr>
  </tbody>
</table>
