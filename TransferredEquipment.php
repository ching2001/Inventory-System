    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="Homepage.php" class="logo">
                ...
                <span class="logo-lg"><b>Transferred</b></span>
            </a>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Transferred Equipments</h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="./Homepage.php"><i class="fa fa-dashboard"></i> Home</a>
                    </li>
                    <li class="active">Transferred</li>
                </ol>
            </section><table class="table">
  <thead>
    <tr>
      <th scope="col">Transferred Equipment</th>
      <th scope="col">Faculty Request</th>
      <th scope="col">Accept/Denied</th>
      <th scope="col">Date</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th scope="row">Computer set Core-i7</th>
      <td>Mark</td>
      <td>Aceept</td>
      <td>Jan, 20 2024</td>
    </tr>
    ...
    <tr>
    <th scope="row">Cpu with Graphics card</th>
      <td>Zed</td>
      <td>Denied</td>
      <td>Jan, 27 2024</td>
    </tr>
